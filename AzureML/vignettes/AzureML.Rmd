...
The **AzureML** R package provides an interface with Microsoft Azure Machine Learning (Azure ML). Currently, the package allows users to access Azure web services. Namely, users are able to publish an R function as a Azure Machine Learning web service, discover the web services already available to their workspace, and consume those web services all from R. This vignette describes the process of getting started and using the package functionality.

## Obtaining Credentials

Before using the package, it is necessary to first obtain the security credentials to your Azure Machine Learning account. You can find this be logging in at [https://studio.azureml.net](Azure ML web site). If you do not have an account, you can create a free account (not guest) to use these APIs.
